...
internal sealed class MeshImportContext
{
    ...
    public UnrealExportTableEntry Export { get; }
    ...
    public static async Task<MeshImportContext> CreateAsync(UnrealHeader header, UnrealExportTableEntry export, int lodIndex)
    {
        ...
        byte[] rawExportData = export.UnrealObjectReader.GetBytes();
