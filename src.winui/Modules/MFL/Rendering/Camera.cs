...
public sealed class Camera : INotifyPropertyChanged
{
    ...
    public bool TryProject(Vector3 world, double viewportWidth, double viewportHeight, out Point screenPoint, out float depth)
    {
    ...
    public ViewportRay CreateRay(Point screenPoint, double viewportWidth, double viewportHeight)
    {
