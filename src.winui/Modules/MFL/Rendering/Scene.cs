...
public sealed class Scene : INotifyPropertyChanged
{
    ...
    private bool ghostInactiveMesh = false;
    ...
    {
        get => showGroundPlane;
        set => SetField(ref showGroundPlane, value);
    }
    ...
    public void SetHighlightedTriangles(
        string meshKey,
        IReadOnlyCollection<int>? triangleIndices,
        int selectedTriangleIndex,
        IReadOnlyCollection<int>? passiveTriangleIndices = null,
        int passiveSelectedTriangleIndex = -1)
    {
        ...
        passive.HighlightedTriangleIndices = passiveTriangleIndices?.ToList() ?? [];
        passive.SelectedTriangleIndex = passiveSelectedTriangleIndex;
    }
